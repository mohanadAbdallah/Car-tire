            ...
            <form action="{{route('customers.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-8 form-group">
                        ...
                        <input type="text" class="form-control rounded-round" placeholder="@lang('app.name') (AR)" name="name_ar"/>
                    </div>

                    <div class="mb-10 form-group">
                        <label for="exampleFormControlInput1" class="required form-label">@lang('app.name') (EN)</label>
                        <input type="text" class="form-control rounded-round" placeholder="@lang('app.name') (EN)" name="name_en"/>
                    </div>
                    <div class="mb-10 form-group">
                        <label for="exampleFormControlInput1" class="required form-label">@lang('app.email')</label>
                        <input type="text" class="form-control rounded-round" placeholder=" @lang('app.email')" name="email"/>
                    </div>
                    <div class="mb-10 form-group">
                        <label for="exampleFormControlInput1" class="required form-label">@lang('app.mobile')</label>
                        <input type="text" class="form-control rounded-round" placeholder=" @lang('app.mobile')" name="mobile"/>
                    </div>
