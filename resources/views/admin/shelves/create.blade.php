...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h2 class="card-title">@lang('app.add_shelf')</h2>
        ...
        <div class="card-body">
            <form action="{{route('shelf.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-lg-6 ml-lg-auto">
                            <div class="mb-8 form-group">
                                ...
                                <input type="text" class="form-control rounded-round" placeholder="@lang('app.shelf_name') " name="name"/>
                            </div>
                        </div>
                        <div class="col-lg-6 ml-lg-auto">
                            <div class="mb-8 form-group">
                                <label for="exampleFormControlInput1" class="required form-label">@lang('app.shelf_number')</label>
                                <input type="text" class="form-control rounded-round" placeholder="@lang('app.shelf_number')" name="shelf_number"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 ml-lg-auto">
                            <div class="mt-4 form-group">
                                <select class=" form-group select" name="status" aria-label=".form-select-lg example">
                                    ...
                                    <option value="0">@lang('app.full_of')</option>
                                    <option value="1">@lang('app.available')</option>
                                    <option value="2">@lang('app.under_maintenance')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6 ml-lg-auto">
                            <div class="mb-8 form-group">
                                ...
                                <input type="text" class="form-control rounded-round" placeholder="@lang('app.capacity')" name="capacity"/>
                            </div>
                        </div>
                    </div>
