...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h3 class="card-title">@lang('app.carType')</h3>
            ...
            <div class="datatable-header">
                <div class="dt-buttons">
                    <button class=" rounded-round dt-button buttons-pdf buttons-html5 btn bg-primary-400" tabindex="0" aria-controls="DataTables_Table_1" type="button"><span>
                            <a class="font-weight-bold font-size-lg" href="{{route('vehicleType.create')}}" style="color: #ffffff"> @lang('app.add') @lang('app.carType')</a> <i class="icon-googleplus5"></i></span></button>
                </div>
            </div>
            <div class="datatable-scroll">
                <form class="rated categories-order-update-form" action="{{route('vehicleType.order.update')}}"
                      method="post"
                    ...
                    <table class="table datatable-reorder dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        ...
                        <tr role="row" class="table-active">
                            ...
                            <th class="text-center font-size-lg sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" data-column-index="2" aria-label="Job Title: activate to sort column ascending">@lang('app.name')(AR)</th>
                            <th class="text-center font-size-lg sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" data-column-index="2" aria-label="Job Title: activate to sort column ascending">@lang('app.name') (EN)</th>
                        ...
                        @foreach($vehicleType as $item)
                            <tr role="row" class="row-tr">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="#" class="to-top">
                                        <i class="icon-circle-up2" style="font-size: 22px;    color: #31ad4c;">
                                ...
                                <td class="text-center">
                                    <div class="list-icons">
                                            <a  href="{{route('vehicleType.edit',$item->id)}}" class=" badge pill list-icons-item">
                                        ...
                                        <a href="{{route('vehicleType.show',$item->id)}}" class=" badge pill list-icons-item">
