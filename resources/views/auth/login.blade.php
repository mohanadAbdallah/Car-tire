...
<body class="bg-slate-800" style="background-color: #212342">
                ...
                <div class="card mb-0 ">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <i> <img src="{{asset('global_assets/images/cartires.png')}}" style="width:20%; margin-bottom:10px;"> </i>
                            <h2 class="mb-0">@lang('app.login')</h2>
                        </div>
